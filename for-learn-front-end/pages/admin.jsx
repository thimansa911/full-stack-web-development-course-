    ...
    return(
        <div className="w-full h-full bg-white flex">
            <div className="w-[300px] h-full bg-blue-400 flex flex-col items-center ">
                ...
                <Link className="flex flex-row w-full p-[15px] items-center text-[17px] gap-[15px] my-2 hover:bg-blue-500 hover:-translate-y-1 hover:shadow-md transition duration-200 bg-blue-300" to="/admin/package" ><FaBox className="text-white" />Packages</Link>
                <Link className="flex flex-row w-full p-[15px] items-center text-[17px] gap-[15px] my-2 hover:bg-blue-500 hover:-translate-y-1 hover:shadow-md transition duration-200 bg-blue-300" to="/admin/order" ><LuClipboardPenLine className="text-white" />Orders</Link>
